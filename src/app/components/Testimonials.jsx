...
const Testimonials = () => {
    ...
    return (
        <section className=" testimonial relative py-14">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                   <h2 className="text-4xl text-gray-800 font-extrabold mx-auto md:text-4xl">
                        Hear from  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5]">Our Customers</span>
                    </h2>
                            ...
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl border shadow-md">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-red-50">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-red-500" />
                                            <div>
                                                <span className="block text-gray-800 font-semibold">{item.name}</span>
                                                <span className="block text-red-600 text-sm mt-0.5">{item.title}</span>
                                            </div>
                                        </div>
                                    </figure>
                                </li>
